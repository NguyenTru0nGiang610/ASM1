...
bool UNIT_TEST_Task3::Task308() {
    ...
    Infantry* infantryNear = new Infantry(10, 5, Position(3, 4), SNIPER); // 1 unit away // 12 60
    Vehicle* vehicleNear = new Vehicle(10, 5, Position(4, 3), TRUCK); // 1 unit away 2
    Infantry* infantryFar = new Infantry(10, 5, Position(3, 8), SNIPER); // 5 units away 12 60
    Vehicle* vehicleFar = new Vehicle(10, 5, Position(8, 3), TRUCK); // 5 units away 2
