...
bool UNIT_TEST_Task3::Task307() {
    ...
    Infantry* infantryAtRiver = new Infantry(10, 5, Position(7, 7), SNIPER); // At the river  12 60
    Infantry* infantryNearby = new Infantry(10, 5, Position(7, 9), SNIPER); // 2 units away 12 60
    Infantry* infantryFar = new Infantry(10, 5, Position(7, 12), SNIPER); // 5 units away 12 60
    Vehicle* vehicleAtRiver = new Vehicle(10, 5, Position(7, 7), TRUCK); // At the river  2
    Vehicle* vehicleNearby = new Vehicle(10, 5, Position(9, 7), TRUCK); // 2 units away  2
    Vehicle* vehicleFar = new Vehicle(10, 5, Position(12, 7), TRUCK); // 5 units away   2
