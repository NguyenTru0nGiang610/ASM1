...
bool UNIT_TEST_Task3::Task207()
{
    ...
    Infantry i1(2, 1, Position(2,1), SNIPER);//2
    Infantry i2(4, 2, Position(2,2), SPECIALFORCES);
    Infantry i3(3, 1, Position(3,2), SNIPER);//3
...
bool UNIT_TEST_Task3::Task212()
{
    ...
    //! data ------------------------------------
    Vehicle v1(3, 1, Position(1,1), TANK);  //61    
    Infantry i1(4, 1, Position(1,2), SNIPER);       //4->5 5
    Infantry i2(3, 1, Position(1,3), SPECIALFORCES); //3->4 228
    ...
    Infantry i4(2, 1, Position(3,3), ANTIAIRCRAFTSQUAD); // 2->3 59   
