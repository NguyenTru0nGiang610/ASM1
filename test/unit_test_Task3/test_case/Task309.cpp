...
bool UNIT_TEST_Task3::Task309() {
    ...
    Infantry* riNear1 = new Infantry(10, 5, Position(6, 6), REGULARINFANTRY); // Inside urban area 9 325
    Infantry* riNear2 = new Infantry(10, 5, Position(10, 6), REGULARINFANTRY); // ~1.4 units away 9 325
    Infantry* riFar = new Infantry(10, 5, Position(12, 6), REGULARINFANTRY); // ~2.8 units away 9 325
    Infantry* spNear = new Infantry(10, 5, Position(8, 8), SPECIALFORCES); // ~2.8 units away 12 284
    Infantry* spFar = new Infantry(10, 5, Position(11, 11), SPECIALFORCES);  // 12 284
    Vehicle* vehicleInside = new Vehicle(10, 5, Position(6, 6), ARTILLERY); // Inside urban area 53
    Vehicle* vehicleNearby = new Vehicle(10, 5, Position(8, 6), ARTILLERY); // 2 units away 53
    Vehicle* vehicleFar = new Vehicle(10, 5, Position(10, 10), ARTILLERY); // ~5.7 units away 53
